    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between w-full">
        ...
        <div className="hidden md:flex items-center gap-3">
          <form onSubmit={handleSearchSubmit} className="flex items-center backdrop-blur-[1px] rounded-full px-3 py-2 border border-white">
      ...
      <div className="relative z-10 max-w-lg text-sm md:text-base md:ml-12 mb-[180px] flex flex-col items-start gap-4">
        <button className="border text-white px-4 py-2 md:px-6 md:py-4 rounded-full md:font-semibold w-auto">
          Sport Center
        </button>

        <h1 className="text-2xl font-light md:text-2xl lg:text-5xl leading-[1.05] md:leading-widest tracking-wider md:tracking-wider text-left">
          Your Play, Your Way — Modern Sports Facilities for Every Passion
        </h1>
      </div>

      <div className="absolute bottom-29 -right-2 md:right-12 md:bottom-22 pointer-events-none border border-[#0054D1] rounded-full inline-flex py-1 px-2">
      ...
      <div className="text-[8px] md:text-[12px] absolute -right-10 top-[30%] md:top-68 md:right-24 md:right-42 w-32 h-32 md:w-40 md:h-40 pointer-events-none flex flex-col items-start md:items-start text-left md:text-left">
